#!/usr/bin/env python3
"""
creates a connection with redis database
"""
import redis
...
class Cache:
    ...
    def store(self, data: Union[str, bytes, int, float]) -> str:
        """ stores new data and returns a new uuid"""
        key = str(uuid4())
    ...
    def get(self,
        ...
        """ gets the element and return the decoded version"""
    ...
    def get_str(self, data: str) -> str:
        """ returns the decoded byte in string """
        return data.decode('utf-8')

    def get_int(self, data: str) -> int:
        """ returns the decoded byte in integer """
        return int(data)
